...
public class CreateRenewBudgetEntity {
    ...
    public CreateRenewBudgetEntity(String category_id, double limit_amount, String renew_date_unit, String custom_renew_date, boolean enable_notification, String currency_unit) {
    ...
    public CreateRenewBudgetEntity(String category_id, double limit_amount, String renew_date_unit, boolean enable_notification, String currency_unit) {
        this.category_id = category_id;
        this.limit_amount = limit_amount;
        this.renew_date_unit = renew_date_unit;
        this.enable_notification = enable_notification;
